...
if (!class_exists('EG_Plugin_103')) {
	...
	Class EG_Plugin_103 {
		...
		/**
		  ...
		  *
		  */
		function EG_Plugin_103($name, $version, $core_file, $options_entry, $default_options='') {
		...
		/**
		  ...
		  * @return object
		  */
		function __construct($name, $version, $core_file, $options_entry, $default_options='') {
...
*/
		...
		function install_upgrade() {
			...
			if ($this->options === FALSE) {
				...
				if (isset($this->default_options)) $this->options = $this->default_options;
				$this->options['version'] = $this->plugin_version;
				...
				if (version_compare($current_version, $this->plugin_version, '<')) {
					if (! isset($this->default_options)) $new_options = $this->options;
					else {
						$new_options = array();
